...
const RESTAURANT_UI_EXAMPLES = `---BEGIN SINGLE_COLUMN_LIST_EXAMPLE---
[
  ...
  {{ "surfaceUpdate": {{"surfaceId": "default", "components": [
      ...
      {{ "id": "card-details", weight: 2, "component": {{ "Column": {{ "children": {{ "explicitList": ["template-name", "template-rating", "template-detail", "template-address", "template-book-button"] }} }} }} }},
      ...
      {{ "id": "template-address", "component": {{ "Text": {{ "text": {{ "path": "address" }} }} }} }},
...
[
  ...
  {{ "surfaceUpdate": {{"surfaceId": "default", "components": [
      ...
      {{ "id": "card-details-1", "component": {{ "Column": {{ "children": {{ "explicitList": ["template-name-1", "template-rating-1", "template-detail-1", "template-address-1", "template-book-button-1"] }} }} }} }},
      ...
      {{ "id": "template-address-1", "component": {{ "Text": {{ "text": {{ "path": "/items/0/address" }} }} }} }},
      ...
      {{ "id": "card-details-2", "component": {{ "Column": {{ "children": {{ "explicitList": ["template-name-2", "template-rating-2", "template-detail-2", "template-address-2", "template-book-button-2"] }} }} }} }},
      ...
      {{ "id": "template-address-2", "component": {{ "Text": {{ "text": {{ "path": "/items/1/address" }} }} }} }},
